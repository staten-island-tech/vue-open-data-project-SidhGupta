...
import DeathRateLineChart from './RaceDeathLineChart.vue';
const cityData = ref([]);
    ...
    if (response.ok) {
      ...
      data.forEach(item => {
        ...
        if (!isNaN(deaths)) {
          ...
          } else if (item.year === "2008") {
            deathsOfTwoTwoEight += deaths;
          } else if (item.year === "2009") {
            deathsOfTwoTwoNine += deaths;
        } else if (item.year === "2010") {
            deathsOfTwoTwoTen += deaths;
        } else if (item.year === "2011") {
            deathsOfTwoTwoEleven += deaths;
        } else if (item.year === "2012") {
            deathsOfTwoTwoTwelve += deaths;
          } else if (item.year === "2013") {
            deathsOfTwoTwoThirteen += deaths;
          } else if (item.year === "2014") {
            deathsOfTwoTwoFourteen += deaths;
          }
        }
      });

      deathCounts.value = {2007: deathsOfTwoSeven, 2008: deathsOfTwoEight, 2009: deathsOfTwoNine, 2010: deathsOfTwoTen, 2011: deathsOfTwoEleven, 2012: deathsOfTwoTwelve, 2013: deathsOfTwoThirteen, 2014: deathsOfTwoFourteen };
